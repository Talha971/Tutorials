...
import "./App.css";
import Image from "./assests/images/flower.jpeg";
...
//       //       {/* self closing tag ko bnd karna zaroori hota hai / ke through */}
//       //       <hr />
//       //     </div>
//       //   );
//       // }
...
// //       />
// //       <br />
// //       {/* /* link yani './images/etc' ki tarhan nhi karsakte images  */}
// //       <img style={{ width: "340px" }} src={logo} alt="" />
// //       {/*                     OR                                    */}
// //       <img src={Image} alt="" />
// //     </div>
// //   );
...
// // // button ke onclick wagera
// // function App() {
//   //   let foo = (a) => {
//     //     console.log("kyun dabaya", a);
//     //   };

//     //   return (
//       //     <div>
//       //       {/* agar () foo ke saath lagaye tou wou khud chal jayega */}
//       //       <button onClick={foo}>daba</button>
//       //       {/* yaa phir */}
//       //       <button onClick={() => foo()}>daba</button>
//       //       {/* ye wala best practice hai argument pass karne keliye */}
//       //       <button onClick={() => foo("hello")}>daba</button>
//       //     </div>
//       //   );
//       // }
...
//     //     <div>
//     //       <ul>
//     //         {/* agar hm key na den tou ye warning dega unique key ke liye tou hm sab main id daal dete hain */}
//     //         {students.map((v, i) => (
//       //           <li key={id}>{v.name}</li>
//       //         ))}
//       //       </ul>
...
import NB from "./components/navbar.jsx";
function App() {
  return (
    <div>
      <NB />
